...
export function TranscriptView({
    ...
    const charCount = useMemo(() => segments.reduce((sum, s) => sum + s.text.length, 0), [segments]);
          ...
          <span
            ...
            <div className="mb-3 flex flex-wrap items-center gap-2">
              ...
              {matchCount} match{matchCount !== 1 ? "es" : ""}
                ...
                {onFilterProfanityChange && (
                    <label className="flex cursor-pointer items-center gap-1.5 text-xs text-slate-600 dark:text-slate-400">
                        <input type="checkbox" checked={filterProfanityProp}
                               onChange={(e) => onFilterProfanityChange(e.target.checked)}
                               className="rounded-sm"/>
                        Filter profanity
                    </label>
                )}
